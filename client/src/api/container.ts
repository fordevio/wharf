...
export const stopContainer = async(token: string, id: string):Promise<AxiosResponse<MessageRes>> => {
    const url = URL + "/api/protected/container/stop/"+id
    const res = await axios.put<MessageRes>(url,{} ,{
        headers: {
            'Token': token
        }
    }
...
export const startContainer = async(token: string, id: string):Promise<AxiosResponse<MessageRes>> => {
...
export const pauseContainer = async(token: string, id: string):Promise<AxiosResponse<MessageRes>> => {
...
export const unpauseContainer = async(token: string, id: string):Promise<AxiosResponse<MessageRes>> => {
